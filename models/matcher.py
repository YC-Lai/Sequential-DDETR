...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        Params:
            ...
            n_frames: the sequence length of frames

        Returns:
            A list of size batch_size*n_frames, containing tuples of (index_i, index_j) where:
        ...
        cost_giou = -generalized_box_iou(out_xyxy, target_xyxy)
