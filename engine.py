...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
                    ...
                    device: torch.device, epoch: int, max_norm: float = 0, comet_logger=None, train_step=0):
    model.train()
    criterion.train()
    ...
    return {k: meter.global_avg for k, meter in metric_logger.meters.items()}, train_step
